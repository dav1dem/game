...
def check_play_button(ai_settings, screen, stats, sb, play_button, ship, aliens, 
    bullets, mouse_x, mouse_y):
    """Запусакает новую игру при нажатии кнопки Play."""
...
def update_screen(ai_settings, screen, stats, sb, ship, aliens, bullets, play_button):
    ...
    # Кнопка Play отображается в том случаеб если ира неактивна.
...
def ship_hit(ai_settings, screen, stats, sb, ship, aliens, bullets):
	...
	# Создание нового флота и размещение корабля в центрею
        create_fleet(ai_settings, screen, ship, aliens)
        ship.center_ship()
...
def check_aliens_bottom(ai_settings, screen, stats, sb, ship, aliens, bullets):
    """Проверяе, добрались ли пришельцы до нижнего края экрана."""
